<%@ Page Language="C#" MasterPageFile="~/QuanTri.master" AutoEventWireup="true" CodeFile="QuanLyDonHang.aspx.cs" Inherits="QuanLyDonHang" Title="Untitled Page" %>
...
Đơn hàng:<asp:GridView style="margin-top:50px" ID="GridView1" runat="server" 
 ...
 <br />
     <textarea id="TextArea1" 
         ...
         <asp:Button style="margin-left:20px" Width=80px ID="btnXuLy" Text="Xử lý" 
         runat="server" onclick="btnXuLy_Click" 
          />
          <asp:Button style="margin-left:20px " Width=80px ID="btnHuyBo" 
         Text="Hủy bỏ" runat="server" onclick="btnHuyBo_Click" />
         <asp:Button style="margin-left:20px" Width=80px ID="btnXuLyXong" Text="Xử lý xong" 
         runat="server" onclick="btnXuLyXong_Click" 
          />
           <asp:Button style="margin-left:20px" Width=80px ID="btnXoa" Text="Xóa" 
